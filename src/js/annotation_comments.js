...
module.exports = () => {
  ...
  return class AnnotationComments {
    ...
    postLoadDataConstructor() {
      ...
      this.controls = new Controls(this.options.bindArrowKeys, this);
      // this.bindEvents();
    ...
    toggleAnnotationMode() {
      ...
      this.active = !this.active // activate or not
      if (!this.active) {
        screenImag.remove("vac-active")
      } else {
    ...
    setBounds(triggerChange = true) {
      ...
      var screenImag =$(".screenshot")
      const $ctrls = screenImag.find('.vjs-control-bar');
  
      // this.bounds.left = screenImag.offset().left;
      // this.bounds.top = screenImag.offset().top;
      // this.bounds.right = this.bounds.left + screenImag.width();
      // this.bounds.bottom = this.bounds.top + screenImag.height();
...
//     postLoadDataConstructor() {
//       // setup initial state and render UI
//       this.annotationState = new AnnotationState();
//       this.annotationState.annotations = this.options.annotationsObjects;

//       this.controls = new Controls(this.options.bindArrowKeys);
//       this.bindEvents();
//       this.setBounds(false);
//       if (this.options.startInAnnotationMode) this.toggleAnnotationMode();
